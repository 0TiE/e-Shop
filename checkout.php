            ...
            <div class="col-md-6 ">
                <div class="form-container">
                    <form autocomplete="off" action="checkout-charge.php" method="POST">
                        ...
                        <input type="hidden" name="product_name" value="<?php echo $product_data["title"] ?>">

                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="pk_test_51LOXSREsnbQjivlPiI3D9zIUK25D8dxjJWi34M1DTVuXyf8jM4QbjnOepZZrunrmKO7cLSVYPPTUT72OQY5FpJhF00ihVudTSh" data-amount=<?php echo str_replace(",", "", $product_data["price"]) * 100 ?> data-name="<?php echo $product_data["title"] ?>" data-description="<?php echo $product_data["title"] ?>" data-currency="LKR" data-locale="auto">
                        </script>
                    </form>
                </div>
            </div>
