                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $productrow["description"] ?>" title="product description">
                                                    <img src="<?php echo $in["code"] ?>" class="img-fluid rounded-start" style="max-width: 200px;">
                                                </span>
                                            ...
                                            <div class="col-md-5">
                                                <div class="card-body">
                                                    ...
                                                    <?php
                                                    $conrs = Database::search("SELECT * FROM `condition` WHERE `id`='" . $productrow["condition_id"] . "'");
                                                    ...
                                                    <input type="number" class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" value="<?php echo $productrow["qty"] ?>">
                                                    <br><br>
