        ...
        <div class=" col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p> Here we are the eShop .lk&trade; to support your for accomplish your dessire
                        by selling high quality products.</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-door-fill"></i> Maradana,Colombo 10,Srilanka.</p>
                    <p><i class="bi bi-envelope-check-fill"></i> eshp@gmail.com</p>
                    <p><i class="bi bi-telephone-fill"></i>  +94112782654</p>
                    <p><i class="bi bi-printer-fill"></i> +94112782654</p>
